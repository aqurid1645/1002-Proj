...
st.markdown('# RECRUITMENT & RESIGNATION 📑')
...
# Recruitment Rate
with tab1:
    rec = pd.read_csv('Datasets/Recruitment & Resignation/recruitment rate.csv')
...
with tab2:
    # Data Tables
    res = pd.read_csv('Datasets/Recruitment & Resignation/resignation rate.csv')
