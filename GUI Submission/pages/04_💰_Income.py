...
#####IMPORTANT PLEASE LOOK AT THE INCOME JUPYTER NOTEBOOK FOR DETAIL EXPLAINATION#####
...
There is a decrease in the percentage change in the Gini coefficient in the years 2019 and 2020 after accounting 
for government transfers and taxes. There is a 0.023% drop from years 2019 and 2022 for the percentage change in the Gini coefficient 
after accounting for government transfers and taxes. The possible decrease and same percentage change between the 2 years are due to the 
COVID-19 situation. There is a decrease in employment and an increase in retrenchment which leads to a percentage change in the Gini coefficient 
of the household.
...
with tab2:
    ...
    with data:
        ...
        There are more e-commerce websites being created and more job opportunities. 
...
with tab3:
    ...
    with data:
        ...
        if choice == 'Annual Change In Income By Gender (Overall)':
            ...
            df5_custom['Q2'] = df5_custom['Q2'].astype(float)
...
In the year 2021 people are starting to adapt with the covid, back to office and work opportunities are open.
...
with tab4:
    ...
    with data:
        ...
        this is due to border closure in the year 2020. There are no tourists coming in for the “Accommodation” and not enough manpower to transport and store goods for the “Transport and Storage” industry. 
