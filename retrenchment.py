...
View patterns and analysis regarding the ***COVID-19*** impact on Singapore
...
# giving slider range
# select_year_slider = st.select_slider('Year range:', options=select_year_range, value=(year_max, year_min))
